 ...
 * 
 * <pre>
 * configure("a" ; 100) construct(1; 1; 10; 20; 50) // command issue prior to first construct
 * </pre>
 * 
 ...
 * 
 * <pre>
 * construct(1; 1; 10; 20; 50) configure("a", "a") // error: too many strings
 * </pre>
 * 
 ...
 * payment coins <b>that are in the storage bin</b>, and individual names of
 * unsold pops to be unloaded from the interior of the machine (for checking).
 * [Note that payment coins in the coin receptacle will remain there!]
 * 
 ...
 * <b>that has been stored in the storage bin</b>. [Note that coins in the coin
 * receptacle should have remained there when unload() was called.] The two
 * numbers are separated by a semicolon. A sequence of comma-separated strings
 * can follow these numbers. If present, it is separated by a semicolon. Each
 * string represents a kind of pop that is expected to be found.
 * 
 * <p>
 * <b>Correct examples:</b>
 * 
...
public class VendingMachineFactory implements IVendingMachineFactory {
	...
	// You MAY NOT change this constructor, except for replacing true with
	// false if you wish
